...
# Реализации алгоритмов/Циклический избыточный код. Материал из Викиучебника 
...
def toStr(datas):
  print(f'CRC32_4: 0x{crc32_4(datas):08x}, CRC32: 0x{crc32(datas):08x}, CRC16: 0x{crc16(datas):04x}, CRC8: 0x{crc8(datas):02x}')
